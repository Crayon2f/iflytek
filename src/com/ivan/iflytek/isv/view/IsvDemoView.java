...
public class IsvDemoView extends JPanel implements ActionListener, ItemListener {
    ...
    public void initButton() {
        ImageIcon imgBtn = new ImageIcon("res/isv/btn.png");

        btnGetPassword = DrawableUtils.createImageButton("获取密码", imgBtn, null);
        btnGetPassword.setBounds(24, 145, 120, 60);
        DrawableUtils.setMouseListener(btnGetPassword, "res/isv/btn");
        add(btnGetPassword);
        ...
        DrawableUtils.setMouseListener(btnQueryModel, "res/isv/btn");
        add(btnQueryModel);
        ...
        DrawableUtils.setMouseListener(btnDeleteModel, "res/isv/btn");
        add(btnDeleteModel);
        ...
        DrawableUtils.setMouseListener(btnRegister, "res/isv/btn");
        add(btnRegister);
        btnRegister.addActionListener(this);

        btnVerify = DrawableUtils.createImageButton("验证", imgBtn, null);
        btnVerify.setBounds(24, 220, 120, 60);
        DrawableUtils.setMouseListener(btnVerify, "res/isv/btn");
        add(btnVerify);
        ...
        DrawableUtils.setMouseListener(btnStopRecord, "res/isv/btn");
        add(btnStopRecord);
        ...
        DrawableUtils.setMouseListener(btnCancelRegister, "res/isv/btn");
        ...
        DrawableUtils.setMouseListener(btnBack, "res/isv/btn");
        add(btnBack);
    ...
    public void initTextArea() {
        ...
        ImageIcon img = new ImageIcon("res/isv/mic_01.png");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btnGetPassword) {
            ...
            labelWav.setIcon(new ImageIcon("res/isv/mic_01.png"));
    ...
    private void updateVolume(final int volume) {
        ...
        labelWav.setIcon(new ImageIcon("res/isv/mic_0" + idx + ".png"));
    }
