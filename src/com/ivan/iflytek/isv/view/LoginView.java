...
public class LoginView extends JPanel implements ActionListener {
     ...
     */
    public LoginView() {
        ImageIcon imgNormalLogin = new ImageIcon("res/isv/btn.png");
        ...
        DrawableUtils.setMouseListener(btnNormalLogin, "res/isv/btn");

        ImageIcon imgAnonyLogin = new ImageIcon("res/isv/btn.png");
        ...
        DrawableUtils.setMouseListener(btnAnonyLogin, "res/isv/btn");
        //匿名登录已不可用
