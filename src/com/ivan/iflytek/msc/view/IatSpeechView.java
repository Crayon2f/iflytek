...
public class IatSpeechView extends JPanel implements ActionListener {
    ...
    public IatSpeechView() {
        jbtnRecognizer = addButton("res/msc/button.png", "开始听写", 0, 320, 330, -1,
                "res/msc/button");

        ImageIcon img = new ImageIcon("res/msc/mic_01.png");
        ...
        jbtnStop = addButton("res/msc/button.png", "停止", 330, 320, 135, -1,
                "res/msc/button");
        jbtnCancel = addButton("res/msc/button.png", "取消", 465, 320, 135, -1,
                "res/msc/button");
        jbtnHome = addButton("res/msc/home.png", "", 20, 20, 1, 1, "res/msc/home");
        jbtnSet = addButton("res/msc/setting.png", "", 534, 20, 1, 1, "res/msc/setting");
...
//			String text = JsonParser.parseIatResult(results.getResultString());
        ...
        public void onVolumeChanged(int volume) {
            ...
            if (volume == 0)
                ...
                volume = 6;
            labelWav.setIcon(new ImageIcon("res/msc/mic_0" + volume + ".png"));
        }
    ...
    public void iatSpeechInitUI() {
        ...
        labelWav.setIcon(new ImageIcon("res/msc/mic_01.png"));
