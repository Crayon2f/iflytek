...
import com.ivan.iflytek.msc.util.JsonParser;
...
public class AsrSpeechView extends JPanel implements ActionListener {
    ...
    public AsrSpeechView() {
        ...
        jbtnRecognizer = addButton("res/msc/button.png", "开始识别", 0, 320, 330, -1,
                "res/msc/button");
        jbtnRecognizer.add(labelWav, BorderLayout.WEST);
        jbtnRecognizer.setEnabled(false);
        jbtnUpload = addButton("res/msc/button.png", "上传", 330, 320, 330, -1,
                "res/msc/button");
