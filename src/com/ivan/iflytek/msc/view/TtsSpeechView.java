...
public class TtsSpeechView extends JPanel implements ActionListener {
    ...
    public TtsSpeechView() {
        jbtnPlay = addButton("res/msc/btn.png", "合成", 0, 320, 150, "res/msc/btn");
        jbtnPause = addButton("res/msc/btn.png", "暂停", 150, 320, 150, "res/msc/btn");
        jbtnResume = addButton("res/msc/btn.png", "恢复", 300, 320, 150, "res/msc/btn");
        jbtnCancel = addButton("res/msc/btn.png", "取消", 450, 320, 150, "res/msc/btn");
        jbtnHome = addButton("res/msc/home.png", "", 20, 20, -1, "res/msc/home");
        jbtnSet = addButton("res/msc/setting.png", "", 534, 20, -1, "res/msc/setting");
