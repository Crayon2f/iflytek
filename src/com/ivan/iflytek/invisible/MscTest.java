package com.ivan.iflytek.invisible;

import com.iflytek.cloud.speech.*;
import com.ivan.iflytek.common.DebugLog;
import com.ivan.iflytek.msc.util.Pcm2wav;
...
public class MscTest {
    ...
    private static final String APP_ID = "5993b3bc";
    ...
    private String test_words = "北京袋鼠部落影业有限公司（简称“袋鼠影业”）定位于“影视互动平台”，面向快速增长的互联网线上内容付费市场，以短视频为营销利器，专注于网生内容的开发、投资、制作、传播和发行。";

    private String pcm_path = "E://test.pcm";

    private String wav_path = "E://test.wav";
    ...
    private boolean onLoop() {
        ...
        try {
            ...
            DebugLog.Log("1:音频流听写            2：上传词表           3：无声合成           4：将pcm转化成wav      5：退出  ");
            ...
            switch (command) {
                ...
                case 4:
                    //将pcm ---> wav
                    new Pcm2wav().convertAudioFiles(pcm_path , wav_path);
                    break;
                case 5:
                    mIsLoop = false;
                    isWait = false;
...
////				"./iat_test.pcm");
//        recognizer.setParameter(SpeechConstant.SPEED, "100");
//        recognizer.setParameter(SpeechConstant.RESULT_TYPE, "plain");
        ...
        try {
            fis = new FileInputStream(new File(pcm_path));
            if (0 == fis.available()) {
...
//        speechSynthesizer.setParameter(SpeechConstant.TTS_BUFFER_EVENT, "1");
        ...
        speechSynthesizer.synthesizeToUri(test_words, pcm_path,
